...
void initIdt()
{
    ...
    outPortB(0x21, 0x04);
    outPortB(0xA1, 0x02);
    outPortB(0x20, 0x01); // move hardware IRQs to interrupts 32-47
    outPortB(0xA1, 0x01);
    outPortB(0x21, 0x0);
    outPortB(0xA1, 0x0);
    ...
    setIdtGate(32, (uint32_t)irq0, 0x08, 0x08E);
    setIdtGate(33, (uint32_t)irq1, 0x08, 0x08E);
    setIdtGate(34, (uint32_t)irq2, 0x08, 0x08E);
    setIdtGate(35, (uint32_t)irq3, 0x08, 0x08E);
    setIdtGate(36, (uint32_t)irq4, 0x08, 0x08E);
    setIdtGate(37, (uint32_t)irq5, 0x08, 0x08E);
    setIdtGate(38, (uint32_t)irq6, 0x08, 0x08E);
    setIdtGate(39, (uint32_t)irq7, 0x08, 0x08E);
    setIdtGate(40, (uint32_t)irq8, 0x08, 0x08E);
    setIdtGate(41, (uint32_t)irq9, 0x08, 0x08E);
    setIdtGate(42, (uint32_t)irq10, 0x08, 0x08E);
    setIdtGate(43, (uint32_t)irq11, 0x08, 0x08E);
    setIdtGate(44, (uint32_t)irq12, 0x08, 0x08E);
